...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        gameControl(scanner, player1Clock, player2Clock, playTimeArray, run1, run2, t1, t2, player1Turn, player2Turn);
    }

    private static void gameControl(Scanner scanner, Clock player1Clock, Clock player2Clock, String[] playTimeArray, Runner run1, Runner run2, Thread t1, Thread t2, boolean player1Turn, boolean player2Turn) {
        while (true) {
